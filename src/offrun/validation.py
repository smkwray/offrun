...
def validate_offrun_package(
    ...
    *,
    ...
    output_keys = [
        ...
        "evidence_grade_figure",
        "source_granularity_figure",
        "manifest",
    ]
    ...
    if isinstance(datasets, Mapping):
        for dataset, key in (
            ...
            ("buyback_source_reconciliation", "buyback_source_reconciliation"),
            ("event_diagnostics", "event_diagnostics"),
            ("results_triage", "results_triage"),
            ("coverage_qa", "coverage_qa"),
            ("announcement_operation_summary", "announcement_operation_summary"),
            ("pretrend_diagnostics", "pretrend_diagnostics"),
            ("placebo_diagnostics", "placebo_diagnostics"),
            ("dealer_source_granularity_audit", "dealer_source_granularity_audit"),
